## Zad. 1
Napisz program `celsius.py`, który dla stopni Celcjusza od 0 do 100 wyświetli odpowiedające stopnie Fahrenheita (F = 32 + 9/5 * C).
...
## Zad. 5
Utwórz program `complement.py`, który w opariu o pętle `for` i instrukcje `if` wyświetli w jednej linii sekwencję komplementarną do sekwencji podanej przez użytkownika.
...
## Zad. 8
Napisz kod, który wypisze wszystkie dwunukleotydowe wyrazy znajdujące się w poniższej sekwencji.
