...
## Zad. 2
W pliku [mirna_human.fasta](../data/mirna_human.fasta) znajdują się sekwencje cząsteczek mikroRNA człowieka. Napisz program `mirna.py`, który wyświetli identyfikatory sekwencji w poniższym formacie:
